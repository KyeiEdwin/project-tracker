...
var require_stringify = __commonJS({
  "node_modules/qs/lib/stringify.js"(exports2, module2) {
    ...
    var sentinel = {};
    var stringify2 = function stringify3(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter3, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel, depth, currentDepth) {
      var obj = object;
      ...
      obj = typeof filter3 === "function" ? filter3(prefix, obj) : obj;
...
var toSafeFlatObject = (thing) => {
  ...
  while (current != null) {
    ...
    for (const prop of props) {
      ...
      if (!hasOwnProperty27(merged, prop)) {
        result2[prop] = thing[prop];
        merged[prop] = true;
      }
    }
    current = prototype2;
...
utils_default.forEach(methodList_default, (method2) => {
...
function normalizeURLForProtocolCheck(url) {
  ...
  return url.slice(start2).replace(urlParserControlCharacters, "");
}
...
function throttle2(fn, freq) {
  ...
  const flushWith = (...args) => invoke2(args);
  ...
  return async (config3) => {
    ...
    try {
      ...
      if (isRequestSupported) {
        utils_default.forEach(DEFAULT_REQUEST_OPTIONS, (value, key2) => {
          if (resolvedOptions[key2] === void 0) {
            resolvedOptions[key2] = value;
          }
        });
...
var Axios = class {
  ...
  _request(configOrUrl, config3) {
    ...
    headers && utils_default.forEach(methodList_default.concat("common"), (method2) => {
...
var CurrentPage = class {
  ...
  swap({
    ...
    const doSwap = () => this.swapComponent({ component: component2, page: page22, preserveState, initialRender });
...
var InitialVisit = class {
  ...
  static handleDefault() {
    ...
    page.set(page.get(), { preserveScroll: true, preserveState: true, initialRender: true }).then(() => {
      if (navigationType.isReload()) {
        Scroll.restore(history.getScrollRegions());
      } else {
